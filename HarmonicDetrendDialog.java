...
/**
 * class HarmonicDetrendDialog - creates a dialog that displays the output of the harmonic detrend
 *
 * @author Dakota Williams
 */
public class HarmonicDetrendDialog extends FilterDialog {
	private final HarmonicDetrendDialog thisDialog = this;
	private int degree;
	 ...
	 */
	public HarmonicDetrendDialog(final JFrame thisFrame, 
							   String title, 
							   boolean modal, 
							   final ECGViewHandler handler,
							   final int index) {
		super(thisFrame, title, modal, handler, index, 8);
